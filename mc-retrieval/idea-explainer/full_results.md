...
| Metric | Baseline | +MVM Pretrain | +Bbox Crop | +Crop+Pretrain |
|--------|----------|---------------|------------|----------------|
...
| Metric | Random | BM25 (TF-IDF) | Text-Only (ST) | Voxel-Only | **Ours (best)** |
|--------|--------|---------------|----------------|------------|-----------------|
| Cat P@1 | ~31%* | 70.59% | 78.27% | 41.78% | **50.30%** |
| Cat P@5 | ~31%* | 69.77% | 74.84% | 41.10% | **47.88%** |
| Cat P@10 | ~31%* | 68.98% | 72.23% | 40.92% | **46.61%** |
| Cat Hit@1 | ~31%* | 70.59% | 78.27% | 41.78% | **50.30%** |
| Cat Hit@5 | ~31%* | 94.12% | 93.04% | 76.35% | **83.31%** |
